...
def get_data_loaders(
    ...
    :return: dictionary with keys: 'train', 'valid', and 'test' containing DataLoaders
    """

    # Force num_workers to 0 for Jupyter safety (optional)
    num_workers = 4
    ...
    test_sampler = torch.utils.data.SubsetRandomSampler(torch.arange(limit)) if limit > 0 else None
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    # Convert from [B, C, H, W] to [B, H, W, C] and clip to [0,1]
